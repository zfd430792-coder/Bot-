...
EXAMPLE_ASK = (
    ...
    "<blockquote>Лицо хорошо видно, в руке листок: сверху крупно код {code}, под "
    "ним {bot}. Человек держит листок в кадре, чтобы надпись было чётко видно, и "
    "говорит: «Мой код — {code}».</blockquote>\n"
